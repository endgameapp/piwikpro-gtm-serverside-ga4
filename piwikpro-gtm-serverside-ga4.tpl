...
[
  ...
  },
  {
  ...
  },
   {
    "type": "TEXT",
    "name": "visitorID",
    "displayName": "Visitor ID (optional)",
    "simpleValueType": true,
    "help": "Allows you to use the application identifier of a visitor instead of a default identifier generated by the analytics."
  },
  {
    "type": "GROUP",
    "name": "dataCollection",
